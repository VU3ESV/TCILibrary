...
public class Channel(uint periodicNumber, ITransceiver transceiver) : IChannel
{
    ...
    public bool VfoLock
    {
        ...
        {
            _vfoLock = value;
            OnVfoLockChanged?.Invoke(this, new ChannelStateChangedEventArgs(_transceiver.PeriodicNumber, PeriodicNumber, _vfoLock));
        }
    }
    ...
    public int RxVolume
    {
        ...
        {
            _rxVolume = value;
            OnRxVolumeChanged?.Invoke(this, new ChannelIntValueChangedEventArgs(_transceiver.PeriodicNumber, PeriodicNumber, _rxVolume));
        }
    }

    public int RxBalance
    {
        get => _rxBalance;
        set
        {
            _rxBalance = value;
            OnRxBalanceChanged?.Invoke(this, new ChannelIntValueChangedEventArgs(_transceiver.PeriodicNumber, PeriodicNumber, _rxBalance));
        }
    }

    public double RxSignalLevelDbm
    {
        get => _rxSignalLevelDbm;
        set
        {
            _rxSignalLevelDbm = value;
            OnRxSignalLevelChanged?.Invoke(this, new ChannelDoubleValueChangedEventArgs(_transceiver.PeriodicNumber, PeriodicNumber, _rxSignalLevelDbm));
        }
    }
    ...
    public event EventHandler<ChannelStateChangedEventArgs> OnVfoLockChanged;
    public event EventHandler<ChannelIntValueChangedEventArgs> OnRxVolumeChanged;
    public event EventHandler<ChannelIntValueChangedEventArgs> OnRxBalanceChanged;
    public event EventHandler<ChannelDoubleValueChangedEventArgs> OnRxSignalLevelChanged;
    ...
    private bool _vfoLock;
    private int _rxVolume;
    private int _rxBalance;
    private double _rxSignalLevelDbm;
}
