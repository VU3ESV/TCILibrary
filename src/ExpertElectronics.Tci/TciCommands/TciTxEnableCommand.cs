...
{
    private TciTxEnableCommand(ITransceiverController transceiverController) => _transceiverController = transceiverController;
    ...
    public bool ProcessCommandResponses(IEnumerable<string> messages)
    {
        ...
        var txEnableMessage = enumerable.FirstOrDefault(_ => _.Contains(Name, StringComparison.OrdinalIgnoreCase));
