...
public class TciDdsCommand : ITciCommand, IDisposable
{
    ...
    private TciDdsCommand(ITransceiverController transceiverController)
    {
    ...
    public bool ProcessCommandResponses(IEnumerable<string> messages)
    {
        ...
        var ddsMessage = enumerable.FirstOrDefault(_ => _.Contains(Name, StringComparison.OrdinalIgnoreCase));
