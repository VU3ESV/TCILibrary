...
public class TciAudioStopCommand : ITciCommand, IDisposable
{
    ...
    private TciAudioStopCommand(ITransceiverController transceiverController) => _transceiverController = transceiverController;
    ...
    public bool ProcessCommandResponses(IEnumerable<string> messages)
    {
        ...
        var audioStopMessage = enumerable.FirstOrDefault(_ => _.Contains(Name, StringComparison.OrdinalIgnoreCase));
