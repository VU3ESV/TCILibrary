...
{
    private TciXitEnableCommand(ITransceiverController transceiverController) => _transceiverController = transceiverController;
    ...
    public bool ProcessCommandResponses(IEnumerable<string> messages)
    {
        ...
        var xitEnableMessage = enumerable.FirstOrDefault(_ => _.Contains(Name, StringComparison.OrdinalIgnoreCase));
