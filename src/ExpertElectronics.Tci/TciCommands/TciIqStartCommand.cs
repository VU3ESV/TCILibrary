...
public class TciIqStartCommand : ITciCommand, IDisposable
{
    ...
    private TciIqStartCommand(ITransceiverController transceiverController) => _transceiverController = transceiverController;
    ...
    public bool ProcessCommandResponses(IEnumerable<string> messages)
    {
        ...
        var iqStartMessage = enumerable.FirstOrDefault(_ => _.Contains(Name, StringComparison.OrdinalIgnoreCase));
